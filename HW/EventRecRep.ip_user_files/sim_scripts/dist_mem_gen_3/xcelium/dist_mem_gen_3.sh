...
#
# Script generated by Vivado on Fri Apr 18 21:11:51 CEST 2025
...
#
# Usage        : dist_mem_gen_3.sh
#                dist_mem_gen_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dist_mem_gen_3.sh [-reset_run]
#                dist_mem_gen_3.sh [-reset_log]
#                dist_mem_gen_3.sh [-help]
#
...
#                script (type 'dist_mem_gen_3.sh -help' for more information).
#
...
# script info
echo -e "dist_mem_gen_3.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dist_mem_gen_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dist_mem_gen_3 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dist_mem_gen_3 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/imperator/Code/RecRepEvent/HW/EventRecRep.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dist_mem_gen_3_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: dist_mem_gen_3.sh [-step]\n\
Usage: dist_mem_gen_3.sh [-lib_map_path]\n\
Usage: dist_mem_gen_3.sh [-reset_run]\n\
Usage: dist_mem_gen_3.sh [-reset_log]\n\
Usage: dist_mem_gen_3.sh [-keep_index]\n\
